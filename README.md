...
Here we use ckb-cli to deploy `validator` to dev chain:
...
We will use curl to interact with polyjuice. Default RPC server listen address is `127.0.0.1:8214`.
...
```json
{
    ...
    "return_data": "0x6060604052600436106100b95763 ...... 7d236b16d049806500029",
    "created_addresses": [
    ...
    "tx": {
        ...
        "cell_deps": [
            ...
            },
            {
                ...
                "out_point": {
                    "index": "0x0",
                    "tx_hash": "0x58b51c0dd67b3705e1399619e0d32a6a7a9c220e34917b1bc77ef878ad7162cd"
                }
            },
            {
                "dep_type": "code",
                "out_point": {
                    "index": "0x0",
                    "tx_hash": "0x135a6ded08380c16d36f12ae3f6f0f54766eb7a9afdb0afb5d63b3ec2e803da0"
                }
            }
        ],
        "version": "0x0",
        "witnesses": [
            "0x5a1500001 ...... 4c4c48f84c4c48f848f94c48fe00000000"
        ],
        "outputs": [
            {
                "type": {
                    "code_hash": "0x4c4d43be6bb887f305123fc70ef433718c336d2ee72ea3ecd88dc982fff97fd9",
                    "hash_type": "data",
                    "args": "0x8c2eb9f3eb0f6ba73a2249fe8eeb02cafa7a25e0"
                },
        ...
        "inputs": [
            {
                ...
                "previous_output": {
                    "index": "0x1",
                    "tx_hash": "0x67070ddd1932b83a22cb58931d4637cb7863bb22ea88059b440bd12e76eb01d7"
                }
            }
        ]
    },
...
The `entrance_contract` field(`0x8c2eb9f3eb0f6ba73a2249fe8eeb02cafa7a25e0`) contrains the ERC20 contract address we will create.
